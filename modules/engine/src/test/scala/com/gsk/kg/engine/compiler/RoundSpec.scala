...
class RoundSpec
  ...
  "perform round function correctly" when {
    "round a valid double numeric" in {
      ...
      val expected = List("\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>", "\"2\"^^<http://www.w3.org/2001/XMLSchema#integer>", "\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>").map(Row(_))
