...
class HoursSpec
  ...
  val expected: List[Row] = List("\"14\"^^<http://www.w3.org/2001/XMLSchema#integer>", "\"08\"^^<http://www.w3.org/2001/XMLSchema#integer>", "\"22\"^^<http://www.w3.org/2001/XMLSchema#integer>").map(Row(_))
