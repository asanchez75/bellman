  ...
  "Funcs on Forms" when {
    ...
    "TypedFuncForms.gt" should {
      ...
      "work for integer values" in {
        ...
        df.select(FuncForms.gt(df("a"), df("b"))).collect() shouldEqual df
          .select(df("expected"))
          .collect()
      }
      ...
      "work in datetimes without a zone" in {
        ...
        forAll { datetime: LocalDateTime =>
          ...
          df.select(FuncForms.gt(df("a"), df("b")))
            .collect() shouldEqual df.select(df("expected")).collect()
        }
      }
    ...
    "TypedFuncForms.lt" should {
      ...
      "work for integer values" in {
        ...
        df.select(FuncForms.lt(df("a"), df("b"))).collect() shouldEqual df
          .select(df("expected"))
          .collect()
      }
      ...
      "work in datetimes without a zone" in {
        ...
        forAll { datetime: LocalDateTime =>
          ...
          df.select(FuncForms.lt(df("a"), df("b")))
            .collect() shouldEqual df.select(df("expected")).collect()
        }
      }
    ...
    "TypedFuncForms.gte" should {
      ...
      "work for integer values" in {
        ...
        df.select(FuncForms.gte(df("a"), df("b"))).collect() shouldEqual df
          .select(df("expected"))
          .collect()
      }
    ...
    "TypedFuncForms.lte" should {
      ...
      "work for integer values" in {
        ...
        df.select(FuncForms.lte(df("a"), df("b"))).collect() shouldEqual df
          .select(df("expected"))
          .collect()
      }
    ...
    "TypedFuncForms.in" should {
      ...
      "return true when exists" in {
        ...
        val result =
          df.select(
            FuncForms.in(df("origin"), List(df("e1"), df("e2"), df("e3")))
          ).collect
      ...
      "return false when empty" in {
        ...
        val result =
          df.select(FuncForms.in(df("e1"), List.empty[Column])).collect
      ...
      "return true when exists and there are null expressions" in {
        ...
        val result =
          df.select(FuncForms.in(df("origin"), List(df("e1"), df("e2"))))
            .collect
